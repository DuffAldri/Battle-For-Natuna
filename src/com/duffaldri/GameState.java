...
//			try {
			...
			time++;
			if(hp.getValue() == 0) this.isLose = true;
		} 
	...
	public void mousePressed(MouseEvent e) {
		...
		int y = e.getY();
		this.isHold = true;
		if(!isLose) this.playerBulletList.add(new PlayerBullet(x - 2, y, 25));
		homeButton.mouseClicked(x, y, sm);
		if(isLose) replayButton.mouseClicked(x, y, sm);
